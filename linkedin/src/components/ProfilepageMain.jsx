          ...
          <Row>
            <Col className="userdetail" xs={12} md={8}>
              ...
              <div className="d-flex px-1">
                <div className="disponibilità d-flex justify-content-between">
                  <div>
                    <p>
                      <strong>
                      ...
                      Ruoli di sviluppatore front-end
                      <br />
                  ...
                  <div>
                    <Button
                      ...
                      onClick={handleShow}
                    >
                      <HiOutlinePencil className="mb-1" />
                    </Button>
                  </div>
                </div>
                <div className="disponibilità d-flex justify-content-between">
                  <div>
                    <p>
                      <strong>Metti in risalto i servizi </strong>che offri,
                      così tu e la tua azienda potrete apparire nei risultati di
                      ricerca.
                      <br />
                      <a href="#">Inizia</a>
                    </p>
