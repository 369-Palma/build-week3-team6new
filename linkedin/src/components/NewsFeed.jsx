...
function NewsFeed() {
  ...
  function pagination(length) {
    let size = Math.ceil(length / 10);

    let pageDiv = $(".pagination");
    let pageDivData = "";
    pageDivData +=
      "<a href='javascript:void(0)' id='firstPage' class='firstPage'>&laquo;</a>";
    let stepSize = 5;
    for (let i = id; i <= stepSize; i++) {
      if (id === i) {
        pageDivData +=
          "<a href='javascript:void(0)' class='pageNo active' id='" +
          i +
          "'>" +
          i +
          "</a>";
        ...
        pageDivData +=
          "<a href='javascript:void(0)' class='pageNo' id='" +
          i +
          "'>" +
          i +
          "</a>";
